 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanTp_Cfg.h
 *   Generation Time: 2024-01-24 00:25:40
...
#endif
#ifndef CANTP_PROCESSOR_TC27X
#define CANTP_PROCESSOR_TC27X
#endif
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_ee3c4bd1 0u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_a51614e7 1u 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_a51614e7 0u 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_eb22513d 0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_c9d885cf     0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_e39092f8     1u 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_c9d885cf 0u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_eb22513d     0u 
...
#define CANTP_EQ2_LOLAYERTXPDUIDOFTXSDUCFG                                                          CanIfConf_CanIfTxPduCfg_Meg_ResDiag_Tp_oDBCNetWork_d97dd71a_Tx
#define CANTP_EQ2_NASOFTXSDUCFG                                                                     21u
#define CANTP_EQ2_NBSOFTXSDUCFG                                                                     6u
#define CANTP_EQ2_NCSOFTXSDUCFG                                                                     41u
#define CANTP_EQ2_PDURTXSDUIDOFTXSDUCFG                                                             PduRConf_PduRDestPdu_Meg_ResDiag_oDBCNetWork_1336e721_Tx
#define CANTP_EQ2_RXFCADDRESSOFTXSDUCFG                                                             255u
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                                               CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_eb22513d
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                                                  CanTpConf_CanTpTxNPdu_CanTpTxNPdu_eb22513d
...
#define CanTp_GetLoLayerTxPduIdOfTxSduCfg(Index)                                                    CanIfConf_CanIfTxPduCfg_Meg_ResDiag_Tp_oDBCNetWork_d97dd71a_Tx
#define CanTp_GetNAsOfTxSduCfg(Index)                                                               21u
#define CanTp_GetNBsOfTxSduCfg(Index)                                                               6u
#define CanTp_GetNCsOfTxSduCfg(Index)                                                               41u
#define CanTp_GetPduRTxSduIdOfTxSduCfg(Index)                                                       PduRConf_PduRDestPdu_Meg_ResDiag_oDBCNetWork_1336e721_Tx
#define CanTp_GetRxFcAddressOfTxSduCfg(Index)                                                       255u
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                                                         CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_eb22513d
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)                                            CanTpConf_CanTpTxNPdu_CanTpTxNPdu_eb22513d
