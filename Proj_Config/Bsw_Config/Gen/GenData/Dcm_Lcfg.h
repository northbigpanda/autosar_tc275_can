...
# define DCM_LCFG_MAJOR_VERSION                                                12u
...
---------------------------------------------- */
# define Dcm_ModeOnComControlModeChange(channelId, mode)                       ((void)(Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09_DcmCommunicationControl_ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09(mode))) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/* ----------------------------------------------
...
extern CONST(uint8, DCM_CONST) Dcm_CfgSvc19SubFuncLookUpTable[3];
...
extern CONST(Dcm_CfgDidMgrDidOpInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpInfo[1];
/*! DID operation classes */
extern CONST(Dcm_CfgDidMgrDidOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrDidOpClassInfo[3];
/*! DID signal operation classes */
extern CONST(Dcm_CfgDidMgrSignalOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrSignalOpClassInfo[2];
/*! RID properties */
...
extern CONST(Dcm_CfgSvc19SubFuncInfoType, DCM_CONST) Dcm_CfgSvc19SubFuncInfo[2];
/*! Indirection from service 0x19 sub functions to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgSvc19SubFuncExecPrecondTable[2];
