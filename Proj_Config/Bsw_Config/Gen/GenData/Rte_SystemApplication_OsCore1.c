...
TASK(OsTask_App10ms_Core1) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_Unreachable */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_RunS2_EcuM_EcuM_MainFunction | Rte_Ev_Run_AppCtrl1_AppCtrl1_MainFuntion); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(OsTask_App10ms_Core1, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_RunS2_EcuM_EcuM_MainFunction | Rte_Ev_Run_AppCtrl1_AppCtrl1_MainFuntion)); /* PRQA S 3417 */ /* MD_Rte_Os */
    ...
    if ((ev & Rte_Ev_Run_AppCtrl1_AppCtrl1_MainFuntion) != (EventMaskType)0)
    {
      /* call runnable */
      AppCtrl1_MainFuntion(); /* PRQA S 2987 */ /* MD_Rte_2987 */
    }
  }
