...
/*lint -restore */
CONST(Dem_GetFDCFPtrType, DEM_CONST) Dem_Cfg_CallbackGetFdc[2] = {
...
CONST(Dem_Cfg_DebounceTableType, DEM_CONST) Dem_Cfg_DebounceTable[2] = {
  ...
  { /*     1 */                -1,             127,            -128, DEM_CFG_DEM_CFG_DEBOUNCETYPE_EXTERNAL_EVENTDEBOUNCEALGORITHMOFDEBOUNCETABLE,      0x06u }   /* [DTC_0x402011] */
};
#define DEM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
