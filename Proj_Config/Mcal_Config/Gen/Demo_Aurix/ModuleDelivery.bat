...
REM *  VERSION   : 1.1.0                                                      **
REM *                                                                         **
REM *  DATE,TIME : 2023-06-16, 11:32:17                                       **
REM *                                                                         **
...
SET PWM_DELIVERY=STD_OFF
SET ADC_DELIVERY=STD_OFF
