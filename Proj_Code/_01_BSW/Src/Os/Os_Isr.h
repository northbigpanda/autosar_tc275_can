...
))
{
  ...
  if((Os_Hal_IntIsInterruptMappingSupported() != 0u) && (Isr->IsMapped == TRUE))                                        /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */
  {
...
{
  /* #10 If the given interrupt is mapped. */
  if((Os_Hal_IntIsInterruptMappingSupported() != 0u) && (Isr->SourceConfig->IsMapped == TRUE))                          /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */
  {
