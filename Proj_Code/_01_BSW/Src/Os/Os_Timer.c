...
ISR(Os_TimerHrtIsr)                                                                                                     /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
{
  ...
  if(Os_TimerHrtIsLogicalCompareValueReached(hrtCounter) != 0u)                                                         /* SBSW_OS_TIMER_HAL_TIMERISLOGICALCOMPAREVALUEREACHED */
  {
...
\ID SBSW_OS_TIMER_HAL_TIMERISLOGICALCOMPAREVALUEREACHED
