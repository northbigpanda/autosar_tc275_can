 ...
 *  \pre          -
 **********************************************************************************************************************/
# define OS_STACK_GETSIZE(StackLabel)           ((uint32)(sizeof(StackLabel) - OS_HAL_STACK_GAP_SIZE))                  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
StackLabel[(ByteSize + OS_HAL_STACK_GAP_SIZE)/sizeof(Os_Hal_StackType)]                                                 /* PRQA S 3410, 3453 */ /* MD_Os_Rule20.7_3410, MD_MSR_FctLikeMacro */
