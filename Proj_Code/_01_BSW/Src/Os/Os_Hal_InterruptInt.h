 ...
 *  \param[in]      IsrConfig     Interrupt configuration to the ISR which shall be disabled.
 *                                Parameter must not be NULL.
 *  \param[in]      IsrMapConfig  Associated mapped interrupt configuration to the ISR.
 *                                Parameter must not be NULL.
 *
 *  \context        ANY
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  InterruptSource   Interrupt source which shall be initialized. Parameter must not be NULL.
 *  \param[in,out]  IsrMapConfig      Associated mapped interrupt configuration to the ISR. Parameter must not be NULL.
 * 
 *  \context        ANY
 *
 *  \reentrant      TRUE
