...
# define DCM_COREINT_MAJOR_VERSION                                   12u
 ...
 *
 *********************************************************************************************************************/
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagSetResDataAsUN(Dcm_MsgContextPtrType    pMsgContext                                                   /* PRQA S 3673 */ /* MD_Dcm_Design_3673 */ /* COV_DCM_UNSUPPORTED X */
                                                             ,Dcm_ConstReadOnlyMsgType pSource
                                                             ,Dcm_MsgLenType           size)
{
 ...
 *
*********************************************************************************************************************/
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagProvideResDataAsUN(Dcm_MsgContextPtrType    pMsgContext                                               /* PRQA S 3219 */ /* MD_MSR_Unreachable */ /* COV_DCM_UNSUPPORTED X */
                                                                 ,Dcm_ConstReadOnlyMsgType pSource
                                                                 ,Dcm_MsgLenType           size)
{
