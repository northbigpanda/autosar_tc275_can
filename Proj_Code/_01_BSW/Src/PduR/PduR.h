 ...
 *********************************************************************************************************************/
# define PDUR_MIXED_ASIL_ERROR_CHECK     STD_OFF

# if (PDUR_MIXED_ASIL_ERROR_CHECK == STD_ON) /* COV_PDUR_VAR_MIXED_ASIL_ERROR_CHECKS */
#  error "These checks are not necessary and not supported in this version."
# endif
...
# define PDUR_SW_MAJOR_VERSION  14u  /**< Major version */
# define PDUR_SW_MINOR_VERSION   0u  /**< Minor version */
