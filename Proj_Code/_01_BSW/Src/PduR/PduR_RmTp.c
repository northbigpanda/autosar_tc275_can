 ...
 *  \pre        -
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(PduR_FmFifoElementRamIdxOfRmBufferedTpPropertiesRamType, PDUR_CODE) PduR_RmTp_GetFmFifoElementRamIdxOfRmBufferedTpPropertiesSafe(PduR_RmBufferedTpPropertiesRomIdxOfRmSrcRomType bufferedTpPropertiesRomIdx);
#endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_FINISHED_TRANSMISSION_ACTIVE(PduR_FmFifoRomIterType fmFifoRomIdx, Std_ReturnType result);
# endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_TRANSMISSION_ACTIVE(PduR_FmFifoRomIterType fmFifoRomIdx, Std_ReturnType result);
# endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE)PduR_RmTp_CheckReady2Transmit_TpTxSmStateHandler(PduR_FmFifoRamIterType fmFifoRomIdx, PduR_RmSrcRomIterType rmSrcIdx);
# endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_ActivateNext(PduR_FmFifoRamIterType fmFifoRamIdx);
# endif
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_GetRmSrcRomIdxOfOldestFmFifoElementSafe(PduR_FmFifoRomIterType fmFifoRomIdx, P2VAR(PduR_RmSrcRomIterType, AUTOMATIC, PDUR_APPL_DATA) rmSrcRomIdx);
# endif
  ...
  PduR_Lock_LockRoutingPathBySrcPdu(rmSrcIdx);
  {
    ...
    if(BUFREQ_OK == PduR_RmTp_StartOfReception(rmSrcIdx, &tempInfo, tempInfo.SduLength, &bufferSizePtr))        /* SBSW_PDUR_EXTERNAL_API_CALL_FORWARDING_ID_AND_PTR */
    {
      if(tempInfo.SduLength <= bufferSizePtr)
      {
        ...
        {
          if(BUFREQ_OK == PduR_Bm_PutDataAsPtr(bmTxBufferRomIdx, &copyInfo))    /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */ /* COV_PDUR_FATAL_ERROR */
          {
                                                                                 ...
                                                                                 P2VAR(PduLengthType, AUTOMATIC, PDUR_APPL_DATA) bufferSizePtr)
{
  ...
  switch (PduR_GetTpRxSmStateOfRmBufferedTpPropertiesRam(PduR_GetRmBufferedTpPropertiesRomIdxOfRmSrcRom(rmSrcIdx))) {
...
# endif
    ...
    if(PduR_Bm_AllocateTxBuffer(fmFifoRomIdx, TpSduLength, metaDataLength, bufferSizePtr, &allocatedTxBufferIdxPtr, TRUE) == BUFREQ_OK)   /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */
    {
      ...
      PduR_SetRmDestRomIdxOfFmFifoElementRam(fmFifoElementRamWriteIdx, (PduR_RmDestRomIdxOfFmFifoElementRamType) PduR_GetRmDestRomStartIdxOfRmSrcRom(rmSrcIdx));       /* SBSW_PDUR_CSL03 */

      /* Mapping Src Handle and current Fifo element */
      PduR_SetFmFifoElementRamIdxOfRmBufferedTpPropertiesRam(PduR_GetRmBufferedTpPropertiesRomIdxOfRmSrcRom(rmSrcIdx), fmFifoElementRamWriteIdx);      /* SBSW_PDUR_CSL03 */
...
# endif
      {
        ...
        if(PduR_RmTp_CheckReady2Transmit_TpTxSmStateHandler(fmFifoRomIdx, rmSrcIdx) == E_OK)
        {
          retVal = BUFREQ_OK;
        }
        else
                                                                                        ...
                                                                                        SduDataPtrType sduDataPtr, P2VAR(PduLengthType, AUTOMATIC, PDUR_APPL_DATA) bufferSizePtr)
{
  ...
  if(PduR_RmTp_GetCurrentlyUsedBmTxBufferRamIdxByRmSrcIdx(rmSrcIdx, &bmTxBufferRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    ...
    retVal = PduR_Bm_PutData(bmTxBufferRomIdx, pduLengthIntern, &sduDataPtr[metadataStartPosition]); /* SBSW_PDUR_STACK_VARIABLE */
                                                                                        ...
                                                                                        SduDataPtrType sduDataPtr, P2VAR(PduLengthType, AUTOMATIC, PDUR_APPL_DATA) bufferSizePtr)
{
  ...
  if(PduR_RmTp_GetCurrentlyUsedBmTxBufferRamIdxByRmSrcIdx(rmSrcIdx, &bmTxBufferRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    retVal = PduR_Bm_PutData(bmTxBufferRomIdx, (PduR_BmTxBufferArrayRamIterType) pduLength, sduDataPtr);        /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_AssignAssociatedBuffer2Destination(PduR_BmTxBufferRomIterType bmTxBufferRomIdx, PduR_RmSrcRomIterType rmSrcIdx)
{
  ...
  for(rmDestRomIdx = PduR_GetRmDestRomStartIdxOfRmSrcRom(rmSrcIdx); (rmDestRomIdx < PduR_GetRmDestRomEndIdxOfRmSrcRom(rmSrcIdx)) && (bmTxBufferInstanceRomIdx < PduR_GetBmTxBufferInstanceRomEndIdxOfBmTxBufferRom(bmTxBufferRomIdx)); rmDestRomIdx++) /* COV_PDUR_ROBUSTNESS */
  {
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_ThresholdReached(PduR_RmSrcRomIterType rmSrcIdx)
{
  ...
  if(PduR_RmTp_GetCurrentlyUsedBmTxBufferRamIdxByRmSrcIdx(rmSrcIdx, &bmTxBufferRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    PduR_BmTxBufferArrayRamIterType availableTotalDataSize = PduR_Bm_GetTotalDataSize(bmTxBufferRomIdx);
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_TriggerTransmissionOfDestinations(PduR_RmSrcRomIterType rmSrcIdx)
{
  ...
  {
    PduR_SetPendingConfirmationsOfFmFifoRam(fmFifoRomIdx, PduR_GetQueuedDestCntOfRmBufferedTpPropertiesRom(PduR_GetRmBufferedTpPropertiesRomIdxOfRmSrcRom(rmSrcIdx))); /* SBSW_PDUR_CSL03 */
    /* Assign Tx Buffer */
...
# if (PDUR_RPGROM == STD_ON)
        if(PduR_IsDestPduEnabled(rmDestRomIdx) == FALSE)
        {
          ...
          PduR_RmTp_FinishTransmission_TpTxSmStateHandler(fmFifoRomIdx, E_NOT_OK);
          retVal &= E_NOT_OK;
        }
        else
# endif
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_CheckReady2Transmit_TpTxSmStateHandler(PduR_FmFifoRamIterType fmFifoRomIdx, PduR_RmSrcRomIterType rmSrcIdx)
{
  ...
  if(PduR_RmTp_GetCurrentlyWrittenFmFifoElementRamIdxByRmSrcIdx(rmSrcIdx, &fmFifoElementRamWriteIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    ...
    if(fmFifoElementRamWriteIdx == fmFifoElementRamReadIdx)
    {
      switch (PduR_GetTpTxSmStateOfFmFifoRam(fmFifoRomIdx))
      {
 ...
 *
 *********************************************************************************************************************/
FUNC(void, PDUR_CODE) PduR_RmTp_FinishTransmission_TpTxSmStateHandler(PduR_FmFifoRomIterType fmFifoRomIdx, Std_ReturnType result)
{
  ...
  switch (PduR_GetTpTxSmStateOfFmFifoRam(fmFifoRomIdx))
  {
    ...
    case PDUR_RM_TX_RECEPTION_TRANSMISSION_ACTIVE_TPTXSMSTATEOFFMFIFORAM:
      PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_TRANSMISSION_ACTIVE(fmFifoRomIdx, result);
      break;

    case PDUR_RM_TX_RECEPTION_FINISHED_TRANSMISSION_ACTIVE_TPTXSMSTATEOFFMFIFORAM:
      PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_FINISHED_TRANSMISSION_ACTIVE(fmFifoRomIdx, result);
      break;
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_FINISHED_TRANSMISSION_ACTIVE(PduR_FmFifoRomIterType fmFifoRomIdx, Std_ReturnType result)
{
  if(PduR_GetPendingConfirmationsOfFmFifoRam(fmFifoRomIdx) == 0u)
  {
    ...
    PduR_RmTp_ActivateNext(fmFifoRomIdx);
  }
  PDUR_DUMMY_STATEMENT(result); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
}
#endif
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_FinishTransmission_TpTxSmStateHandler_RM_TX_RECEPTION_TRANSMISSION_ACTIVE(PduR_FmFifoRomIterType fmFifoRomIdx, Std_ReturnType result)
{
  if(PduR_GetPendingConfirmationsOfFmFifoRam(fmFifoRomIdx) == 0u)
  {
    ...
    if(result != E_OK)
    {
      ...
      if(PduR_RmTp_GetRmSrcRomIdxOfOldestFmFifoElementSafe(fmFifoRomIdx, &rmSrcRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
      {
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_FinishReception_TpTxSmStateHandler_RM_TX_RECEPTION_ACTIVE(PduR_RmSrcRomIterType rmSrcIdx, Std_ReturnType result)
{
  ...
  {
    PduR_Fm_ReleaseFifoElement(PduR_Fm_GetFmFifoElementRamReadIdxOfFmFifoRamSafe(fmFifoRomIdx));
    PduR_SetTpTxSmStateOfFmFifoRam(fmFifoRomIdx, PDUR_RM_TX_IDLE_TPTXSMSTATEOFFMFIFORAM);     /* SBSW_PDUR_CSL01 */
    PduR_RmTp_ActivateNext(fmFifoRomIdx);
  }
}       /* PRQA S 6080 */ /* MD_MSR_STMIF */
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_ActivateNext(PduR_FmFifoRamIterType fmFifoRamIdx)
{
  ...
  while(PduR_Fm_Peek(fmFifoRamIdx, &fmFifoElementRamReadIdx) == E_OK)      /* SBSW_PDUR_STACK_VARIABLE */
  {
    PduR_RmSrcRomIterType rmSrcIdx;
    PduR_FmFifoElementRamIterType fmFifoElementRamWriteIdx;

    if(PduR_RmTp_GetRmSrcRomIdxOfOldestFmFifoElementSafe(fmFifoRamIdx, &rmSrcIdx) == E_NOT_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
    {
    ...
    {
      PduR_SetTpTxSmStateOfFmFifoRam(fmFifoRamIdx, PDUR_RM_TX_RECEPTION_FINISHED_TRANSMISSION_ACTIVE_TPTXSMSTATEOFFMFIFORAM); /* SBSW_PDUR_CSL03 */

      if(PduR_RmTp_TriggerTransmissionOfDestinations(rmSrcIdx) != E_OK) /* COV_PDUR_ONLY_DEFERRED_TP_QUEUED_ROUTINGS */
      {
        PduR_SetTpTxSmStateOfFmFifoRam(fmFifoRamIdx, PDUR_RM_TX_IDLE_TPTXSMSTATEOFFMFIFORAM); /* SBSW_PDUR_CSL03 */
      }
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_GetCurrentlyWrittenFmFifoElementRamIdxByRmSrcIdx(PduR_RmSrcRomIterType rmSrcIdx, P2VAR(PduR_FmFifoElementRamIterType, AUTOMATIC, PDUR_APPL_DATA) fmFifoElementRamIdx)
{
  ...
  PduR_FmFifoElementRamIterType readFmFifoElementRamIdx = PduR_RmTp_GetFmFifoElementRamIdxOfRmBufferedTpPropertiesSafe(PduR_GetRmBufferedTpPropertiesRomIdxOfRmSrcRom(rmSrcIdx));
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_GetCurrentlyUsedBmTxBufferRamIdxByRmSrcIdx(PduR_RmSrcRomIterType rmSrcIdx, P2VAR(PduR_BmTxBufferRomIterType, AUTOMATIC, PDUR_APPL_DATA) bmTxBufferRomIdx)
{
  ...
  if(PduR_RmTp_GetCurrentlyWrittenFmFifoElementRamIdxByRmSrcIdx(rmSrcIdx, &fmFifoElementRamWriteIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    retVal = PduR_Fm_GetCurrentlyUsedBmTxBufferRomIdxByFmFifoElementIdx(fmFifoElementRamWriteIdx, bmTxBufferRomIdx); /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */
  }
  else
  {
    retVal = E_NOT_OK;
...
LOCAL_INLINE FUNC(PduR_FmFifoElementRamIdxOfRmBufferedTpPropertiesRamType, PDUR_CODE) PduR_RmTp_GetFmFifoElementRamIdxOfRmBufferedTpPropertiesSafe(PduR_RmBufferedTpPropertiesRomIdxOfRmSrcRomType bufferedTpPropertiesRomIdx)
{
  PduR_FmFifoElementRamIdxOfRmBufferedTpPropertiesRamType fmFifoElementRamIdx = PduR_GetFmFifoElementRamIdxOfRmBufferedTpPropertiesRam(bufferedTpPropertiesRomIdx);

# if (PDUR_MIXED_ASIL_ERROR_CHECK == STD_ON) /* COV_PDUR_VAR_MIXED_ASIL_ERROR_CHECKS */
  PduR_FmFifoRamIterType fmFifoRomIdx = PduR_GetFmFifoRomIdxOfRmBufferedTpPropertiesRom(bufferedTpPropertiesRomIdx);
  PduR_FmFifoElementRamStartIdxOfFmFifoRomType startIdx = PduR_GetFmFifoElementRamStartIdxOfFmFifoRom(fmFifoRomIdx);
  PduR_FmFifoElementRamEndIdxOfFmFifoRomType   endIdx   = PduR_GetFmFifoElementRamEndIdxOfFmFifoRom(fmFifoRomIdx);

  if((fmFifoElementRamIdx >= endIdx) && (fmFifoElementRamIdx != PDUR_NO_FMFIFOELEMENTRAMIDXOFRMBUFFEREDTPPROPERTIESRAM))
  {
    fmFifoElementRamIdx = endIdx - 1u;
    PduR_ReportRuntimeDetError(0xAAu, 0xAAu);
  }
  if((fmFifoElementRamIdx < startIdx) && (fmFifoElementRamIdx != PDUR_NO_FMFIFOELEMENTRAMIDXOFRMBUFFEREDTPPROPERTIESRAM))
  {
...
LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_GetRmSrcRomIdxOfOldestFmFifoElementSafe(PduR_FmFifoRomIterType fmFifoRomIdx, P2VAR(PduR_RmSrcRomIterType, AUTOMATIC, PDUR_APPL_DATA) rmSrcRomIdx)
{
  ...
  if(PduR_Fm_GetRmDestRomIdxOfFmFifoElementRamSafe(PduR_Fm_GetFmFifoElementRamReadIdxOfFmFifoRamSafe(fmFifoRomIdx), &rmDestRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    PduR_RmSrcRomIterType readRmSrcRomIdx = PduR_GetRmSrcRomIdxOfRmDestRom(rmDestRomIdx);

# if (PDUR_MIXED_ASIL_ERROR_CHECK == STD_ON) /* COV_PDUR_VAR_MIXED_ASIL_ERROR_CHECKS */
    if(PduR_IsRmBufferedTpPropertiesRomUsedOfRmSrcRom(readRmSrcRomIdx))
    {
      PduR_FmFifoRomIterType supposedfmFifoRomIdx = PduR_GetFmFifoRomIdxOfRmBufferedTpPropertiesRom(PduR_GetRmBufferedTpPropertiesRomIdxOfRmSrcRom(readRmSrcRomIdx));

      if(supposedfmFifoRomIdx == fmFifoRomIdx)
      {
