 ...
 * \reentrant     TRUE
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(Dem_Cfg_DebounceLoResTimerType, DEM_CODE)
Dem_Cfg_DebounceLoResTimerValue(
  void
  );
#endif
...
#if ((DEM_CFG_SUPPORT_IUMPR == STD_ON) && (DEM_CFG_SUPPORT_500MI_DENOMINATOR == STD_ON))
/* ****************************************************************************
 * Dem_Cfg_Obd500MileDenominatorIterExists
 *****************************************************************************/
/*!
 * \brief         Test if the iterator points to a valid element
 *
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_Obd500MileDenominatorIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_Obd500MileDenominatorIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 * \config        ((DEM_CFG_SUPPORT_IUMPR == STD_ON)
...
#if ((DEM_CFG_SUPPORT_IUMPR == STD_ON) && (DEM_CFG_SUPPORT_500MI_DENOMINATOR == STD_ON))
/* ****************************************************************************
 * Dem_Cfg_Obd500MileDenominatorIterGet
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
...
#if ((DEM_CFG_SUPPORT_IUMPR == STD_ON) && (DEM_CFG_SUPPORT_500MI_DENOMINATOR == STD_ON))
/* ****************************************************************************
 * Dem_Cfg_Obd500MileDenominatorIterInit
 *****************************************************************************/
/*!
 * \brief         Init the iterator
 *
 * \details       Initializes the iterator to enumerate all configured ratios 
 *                with 500 miles denominator
 *
 * \param[out]    IterPtr
 *                Pointer to the iterator
 *
...
#if ((DEM_CFG_SUPPORT_IUMPR == STD_ON) && (DEM_CFG_SUPPORT_500MI_DENOMINATOR == STD_ON))
/* ****************************************************************************
 * Dem_Cfg_Obd500MileDenominatorIterNext
 *****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
