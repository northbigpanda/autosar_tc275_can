 ...
 *****************************************************************************/
/*!
 * \brief         Clear the bitfield of processed Combined DTC groups for the 
 *                selected operation.
 *
 * \details       Clear the bitfield of processed Combined DTC groups for the 
 *                selected operation.
 *
 * \param[in]     SelectedOperationIndex
 *                The enumeration indicating an operation, whose Combined DTC 
 *                processing state should be returned.
 *
 * \pre           -
 * \config        -
 *
 ...
 *
 * \return        TRUE
 *                The operation was processed for the combined group
 *
 * \return        FALSE
 *                The operation was not processed for the combined group
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Marks the combined group as processed for the selected 
 *                operation.
 *
 * \details       Marks the combined group as processed for the selected 
 *                operation.
 *
* \param[in]      GroupId
 *                Unique identifier of the combined event group
