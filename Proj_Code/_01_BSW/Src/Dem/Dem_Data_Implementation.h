  ...
  )
{
  ...
  if ( (ReadinessGroup != DEM_CFG_READINESS_NONE)                                                                                /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
...
# endif
  {
    ...
    /* Set all readiness groups to supported and not completed
       (Not supported/ completed = 0, Supported/ not completed = 1)  */
...
# endif
      ...
      if ((0U == Dem_Cfg_EventTripTarget(EventId))                                                                               /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
# if (DEM_CFG_SUPPORT_PERMANENTDTC_IMMEDIATE_VISIBLE == STD_ON)
          || (Dem_EventInternalStatus_Test_QualifyStatus_WIR(lQualifyState) == TRUE)
# endif
         )
      { 
