...
# if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_USER_CONTROLLED_WIR == STD_ON))
  ...
  )
{
  ...
  Dem_DTC_InitCombinedGroupProcessingStatus((Dem_DTC_OperationType)Dem_DTC_QualificationProcessing);
...
# if (DEM_CFG_AGING_RETAIN_MEMORY_ENTRY == STD_ON)
    ...
    if (lGroupId != DEM_CFG_COMBINED_GROUP_INVALID)
    {
      if (Dem_DTC_TestGroupProcessed(lGroupId, 
                                     (Dem_DTC_OperationType)Dem_DTC_QualificationProcessing) == TRUE)
      {
        continue;                                                                                                                /* PRQA S 0770 */ /* MD_DEM_14.5 */
      }
      else
...
# if (DEM_CFG_SUPPORT_PERMANENTDTC_IMMEDIATE_VISIBLE == STD_ON)
    if ((Dem_UDSStatus_Test_WIR(lOldDtcStatus) == FALSE)                                                                         /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
...
# if (DEM_CFG_SUPPORT_WWHOBD == STD_ON || DEM_DEV_RUNTIME_CHECKS == STD_ON)
    Dem_Cfg_MemoryEntryHandleType lMemoryEntryId;
    lMemoryEntryId = Dem_MemoryEntry_GetId(lMemoryIndex);
#endif
...
# if (DEM_CFG_NOTIFY_CLEAR_ALLOWED == STD_ON)
       ...
       Dem_Cfg_CombinedGroupIterNext(&lGroupIter))                                                                               /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Cfg_EventAvailableByVariant(lSubEventId) == TRUE)
    {
      if ((Dem_EventInternalStatus_TestEventDisconnected(Dem_Event_GetInternalStatus(lSubEventId)) == FALSE)                     /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
        && (Dem_ClearTask_ClearEventAllowed(lSubEventId) == FALSE))
      {
        lClearAllowed = FALSE;
        break;
      }
...
)
{
       ...
       Dem_Cfg_CombinedGroupIterNext(&lGroupIter))                                                                               /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Cfg_EventAvailableByVariant(lSubEventId) == TRUE)
    {
      if (Dem_EventInternalStatus_TestEventDisconnected(Dem_Event_GetInternalStatus(lSubEventId)) == FALSE)
      {
        lReturnValue |= Dem_Event_ProcessCleared(lSubEventId);
      }
    }
  }
...
/* ****************************************************************************
 % Dem_DTC_InitCombinedGroupProcessingStatus
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DTC_InitCombinedGroupProcessingStatus(                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(Dem_DTC_OperationType, AUTOMATIC) SelectedOperationIndex
  )
{
#if (DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON)
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if (SelectedOperationIndex >= Dem_Cfg_GetSizeOfProcessedCombinedDTCGroups())
  {
    Dem_Error_RunTimeCheckFailed(DEM_DTC_IMPLEMENTATION_FILENAME, __LINE__);                                                     /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
  else
# endif
  {
    ...
    for (lBitfieldIterator = 0;
         lBitfieldIterator < DEM_DTC_BITFIELDS_IN_COMBDTCGRP_BUFFER;
         lBitfieldIterator++)
    {
      (Dem_Cfg_GetProcessedCombinedDTCGroups(SelectedOperationIndex))[lBitfieldIterator] = 0;                                    /* SBSW_DEM_ARRAY_WRITE_PROCESSEDCOMBINEDDTCGROUPS */
    }
  }
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(SelectedOperationIndex)                                                                       /* PRQA S 3112 */ /* MD_DEM_14.2 */
#endif
}

/* ****************************************************************************
 % Dem_DTC_TestGroupProcessed()
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_DTC_TestGroupProcessed(                                                                                                      /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(Dem_Cfg_CombinedGroupIndexType, AUTOMATIC) GroupId,
  CONST(Dem_DTC_OperationType, AUTOMATIC) SelectedOperationIndex
  )
{
  boolean lGroupProcessed;
  lGroupProcessed = FALSE;                                                                                                       /* PRQA S 3198 */ /* MD_DEM_3198_na */

#if (DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON)
  Dem_Internal_AssertReturnValue(SelectedOperationIndex < Dem_Cfg_GetSizeOfProcessedCombinedDTCGroups(), 
                                 DEM_E_INCONSISTENT_STATE, TRUE)
  {
    /* Check whether bit in the corresponding bit field is set */
    lGroupProcessed = Dem_Com_TestBitInBitfield(Dem_Cfg_GetProcessedCombinedDTCGroups(SelectedOperationIndex),                   /* SBSW_DEM_POINTER_FORWARD_PROCESSED_COMBINEDDTC_GROUPS */
                                                DEM_DTC_BITFIELDS_IN_COMBDTCGRP_BUFFER,
                                                GroupId);
  }
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(GroupId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DTC_SetGroupProcessed(                                                                                                       /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
  CONST(Dem_Cfg_CombinedGroupIndexType, AUTOMATIC) GroupId,
  CONST(Dem_DTC_OperationType, AUTOMATIC) SelectedOperationIndex
  )
{                                                                                                  
...
# endif
  {
    ...
    Dem_Com_SetBitInBitfield(Dem_Cfg_GetProcessedCombinedDTCGroups(SelectedOperationIndex),                                      /* SBSW_DEM_POINTER_FORWARD_PROCESSED_COMBINEDDTC_GROUPS */
                             DEM_DTC_BITFIELDS_IN_COMBDTCGRP_BUFFER, 
                             GroupId);
  }
#else
...
#if ((DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON) \
    && ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_USER_CONTROLLED_WIR == STD_ON)))
/* ****************************************************************************
  ...
  )
{
  ...
  lReturnValue = (boolean)                                                                                                       /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
    ...
    || ( (Dem_DTC_TestDtcAvailable(EventId) == FALSE)
      && (Dem_DTC_TestStoredStatusOnDtcRetrieval(EventId) == FALSE) )
     );
  return lReturnValue;
}
  ...
  )
{
  ...
  if (DTCContext->GroupId != DEM_CFG_COMBINED_GROUP_INVALID)
  {
    if ( (Dem_UDSStatus_Test_TF(DTCContext->OldDtcStatus) == TRUE)                                                               /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
    ...
    if ( (Dem_UDSStatus_Test_TNCTOC(DTCContext->OldDtcStatus) == TRUE)                                                           /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
      && (Dem_UDSStatus_Test_TNCTOC(DTCContext->NewDtcStatus) == FALSE))
    {
...
# endif
  ...
  if (Dem_Event_TestMilSupport(EventId) == TRUE)
  {
    ...
    if ((Dem_UDSStatus_Test_CDTC(lOldInternalDtcStatus) == TRUE)                                                                 /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
...
#  endif
    {
      if ((Dem_UDSStatus_Test_TNCTOC(OldUdsStatus) == FALSE)                                                                     /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
#  if (DEM_CFG_AGING_00_START_TESTS_TFTOC == STD_ON)
...
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_DTC_Passed_ProcessDTCEffects(
CONSTP2VAR(Dem_Event_ContextType, AUTOMATIC, AUTOMATIC) EventContext,                                                            /* PRQA S 3673 */ /* MD_DEM_16.7_False */
CONSTP2CONST(Dem_DTC_ContextType, AUTOMATIC, AUTOMATIC) DTCContext
)
{
#if (DEM_FEATURE_NEED_PID01_CALCULATION == STD_ON)
  ...
  if ((Dem_Cfg_EventUdsDtc(DTCContext->EventId) != DEM_CFG_DTC_UDS_INVALID)                                                      /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
...
#endif
      {
        EventContext->DataModified = Dem_Memory_UpdateEventEntryOnPassed(DTCContext->EventId,                                    /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
                                       DTCContext->DtcEffects, lMemoryIndex);                                                                                 

        if (DEM_DATA_TEST_USERDATA_CHANGED(EventContext->DataModified))
        {
          if (Dem_Cfg_EventSupportImmediateNv(DTCContext->EventId) == TRUE)
          {
            Dem_Nvm_SetEventMemoryBlockState(lMemoryIndex, DEM_NVM_BLOCKSTATE_DIRTYIMMEDIATE);
  ...
  DEM_IGNORE_UNUSED_ARGUMENT(EventContext->DataModified)                                                                         /* PRQA S 3112 */ /* MD_DEM_14.2 */ /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
}                                                                                                                                /* PRQA S 6050, 6080 */ /* MD_MSR_STCAL, MD_MSR_STMIF */
  ...
  )
{
  ...
  { /* store OBD II Freeze Frame, no event entry required */
    Dem_Memory_TriggerObdIIFreezeFrameStorage(DTCContext->EventId, DTCContext->DtcEffects);
  }
  ...
  if (lMemoryIndex != DEM_MEM_INVALID_MEMORY_INDEX)
  {
    ...
    lIsOccurrence |= (boolean)((DTCContext->DtcEffects & DEM_ESM_EVENT_OCCURENCE_TRIGGER) != 0);
    ...
    if ((DEM_DATA_TEST_USERDATA_CHANGED(lBlockModification)                                                                      /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
      || (lIsOccurrence == TRUE))                                                
...
# if (DEM_CFG_SUPPORT_TRIGGER_FDC_FIRST_IN_CYCLE == STD_ON)
    ...
    if (( (lUpdateFlags & DEM_CFG_TRIGGER_FDC_FIRST_IN_CYCLE) != 0)                                                              /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
#  if (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON)
