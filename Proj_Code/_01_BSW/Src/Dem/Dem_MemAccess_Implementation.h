  ...
  )
{
  ...
  if ( (Dem_UDSStatus_Test_TNCTOC(BestMatchInfo->UdsStatus) == FALSE)                                                            /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
  ...
  )
{
  ...
  for (; (lMemoryIndex < lMemoryIndexEnd)                                                                                        /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
    && (Dem_MemoryEntry_GetEventId(Dem_MemoryEntry_GetId(lMemoryIndex)) != lMemoryRepresentativeEvent);
    ++lMemoryIndex) 
  {  }
