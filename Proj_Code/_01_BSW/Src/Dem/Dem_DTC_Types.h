...
/*! Number of bitfields representing Combined DTC groups in Dem_Cfg_ProcessedCombinedDTCGroups. 
    Each bit represents a Combined DTC Group. */
#define DEM_DTC_BITFIELDS_IN_COMBDTCGRP_BUFFER             DEM_CFG_PROCESSEDCOMBINEDDTCGROUP_SIZE 
#endif
...
/*! Enum encapsulating an ongoing DEM operation. 
    This enum shall be used to track whether the 'Operation' was performed on a Combined DTC Group */
typedef enum
{
  Dem_DTC_QualificationProcessing = 0U      /*!< Recalculation of DTC Qualification State */
} DEM_DTC_OperationProgressType;
