...
# if (DEM_CFG_AGING_RETAIN_MEMORY_ENTRY == STD_ON)
      (Dem_DTC_GetAgingCounter(EventId, lMemoryEntryId) == DEM_OPERATIONCYCLE_CYCLECOUNT_AGED)                                   /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
      ||
# endif
#endif
      (Dem_MemoryEntry_TestAgingOnlyEntry(lMemoryEntryId) == TRUE)
     )
  {
    lUpdateable = FALSE;
  }
