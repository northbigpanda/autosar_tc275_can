  ...
  )
{
  ...
  if (EnableConditionID >= Dem_Cfg_GetSizeOfEnableConditionState())
  {
...
#endif
  {
    Dem_Cfg_SetEnableConditionState(EnableConditionID, ActiveStatus);                                                            /* SBSW_DEM_ARRAY_WRITE_ENABLECONDITIONSTATE */
  }
}
