...
/* >>>> -------------------------------- Enter Critical Section: DiagMonitor */
            ...
            if ( (DEM_ESM_TEST_IUMPR_DEN_INCREMENTED(lRatioStatus) == FALSE) &&                                                  /* not yet incremented AND */ /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
                 (DEM_ESM_TEST_IUMPR_DEN_LOCKED(lRatioStatus) == FALSE) &&                                                       /* not locked AND */
                 (Dem_IumprIF_TestGeneralDenominatorIncrementConditionFulfilled(lRatioIndex) == TRUE) &&                         /* general conditions fulfilled AND*/
...
# if (DEM_CFG_SUPPORT_500MI_DENOMINATOR == STD_ON)
              if ( (Dem_IumprIF_Test500MileDenominatorConfigured() == TRUE)                                               /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
                   && (Dem_Cfg_ObdIumprDenGroup(lRatioIndex) == DEM_IUMPR_DEN_500MI) )
              {
                  lRatioStatus = DEM_IUMPRIF_RESET_IUMPR_500MI_GENDEN_CONDITIONS_REACHED(lRatioStatus);    
              }
# endif
...
/* <<<< -------------------------------- Leave Critical Section: DiagMonitor */
    ...
    {
      if ((Dem_Data_TestReadinessDynamicallyCalculated(lGroupIter, DEM_DATA_PIDCONTEXT_PID01) == TRUE)                           /* PRQA S 3415 */ /* MD_DEM_12.4_cf */
