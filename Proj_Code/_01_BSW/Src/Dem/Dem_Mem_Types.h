...
#define DEM_MEM_SET_NON_QUALIFIED_STATUS_BITS(Reg)            ((uint8)((Reg) | 0x77U))                                           /* PRQA S 3453 */ /* MD_MSR_19.7 */
/*! Applies qualified status to memory entry status byte */
#define DEM_MEM_APPLY_QUALIFIED_STATUS(State, QualifyStatus)  ((uint8)(((State) & 0x77U) | ((QualifyStatus) & 0x88U)))           /* PRQA S 3453 */ /* MD_MSR_19.7 */
