...
#if (  (COMM_SW_MAJOR_VERSION != (0x11u)) \
...
#if (  (COMM_BUSSM_MAJOR_VERSION != (0x11u)) \
...
#if (COMM_DCM_INDICATION == STD_ON)
# if (  (COMM_DCM_MAJOR_VERSION != (0x11u)) \
...
#if (  (COMM_ECUMBSWM_MAJOR_VERSION != (0x11u)) \
...
#if (  (COMM_NM_MAJOR_VERSION != (0x11u)) \
...
#if (  (COMM_TYPES_MAJOR_VERSION != (0x11u)) \
