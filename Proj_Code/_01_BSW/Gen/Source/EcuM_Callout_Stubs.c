 ...
 *********************************************************************************************************************/
  ...
  while(1)
  {
	  /* Before switch to Sleep Mode, Transceiver must to switch to Normal Mode to clear wakeup flag*/
	  CanTrcv_30_Tja1043_SetOpMode(CanTrcv_30_Tja1043_CanTrcvChannel, CANTRCV_30_TJA1043_OP_MODE_NORMAL);
	  CanTrcv_30_Tja1043_SetOpMode(CanTrcv_30_Tja1043_CanTrcvChannel, CANTRCV_30_TJA1043_OP_MODE_STANDBY);
	  CanTrcv_30_Tja1043_SetOpMode(CanTrcv_30_Tja1043_CanTrcvChannel, CANTRCV_30_TJA1043_OP_MODE_SLEEP);
	  for(i = 0; i < 100000; i++);
  }
 ...
 *********************************************************************************************************************/
  ...
  if((wakeupSource & ECUM_WKSOURCE_CN_DBCNetWork_9ed72b09) == ECUM_WKSOURCE_CN_DBCNetWork_9ed72b09)
  {
	CanSM_StopWakeupSources(0, ECUM_WKSOURCE_CN_DBCNetWork_9ed72b09);
  }
  else
  {
	/*Do Nothing*/
