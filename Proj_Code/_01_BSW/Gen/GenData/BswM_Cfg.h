...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_BswMRule_App_ComM_Request (0) 
#define BswMConf_BswMRule_CC_CN_DBCNetWork_9ed72b09_RX (1) 
#define BswMConf_BswMRule_CC_CN_DBCNetWork_9ed72b09_RX_DM (2) 
#define BswMConf_BswMRule_CC_CN_DBCNetWork_9ed72b09_TX (3) 
...
#define BSWM_ECUMWAKEUPMAPPING                                                                      STD_ON
#define BSWM_EXTERNALIDOFECUMWAKEUPMAPPING                                                          STD_ON
#define BSWM_IMMEDIATEUSERENDIDXOFECUMWAKEUPMAPPING                                                 STD_ON
#define BSWM_IMMEDIATEUSERSTARTIDXOFECUMWAKEUPMAPPING                                               STD_ON
#define BSWM_IMMEDIATEUSERUSEDOFECUMWAKEUPMAPPING                                                   STD_ON
#define BSWM_INITVALUEOFECUMWAKEUPMAPPING                                                           STD_ON
#define BSWM_ECUMWAKEUPSTATE                                                                        STD_ON
...
#define BSWM_SIZEOFECUMWAKEUPMAPPING                                                                STD_ON
#define BSWM_SIZEOFECUMWAKEUPSTATE                                                                  STD_ON
...
#define BSWM_ECUMWAKEUPMAPPINGOFPCPARTITIONCONFIG                                                   STD_ON
#define BSWM_ECUMWAKEUPSTATEOFPCPARTITIONCONFIG                                                     STD_ON
...
#define BSWM_SIZEOFECUMWAKEUPMAPPINGOFPCPARTITIONCONFIG                                             STD_ON
#define BSWM_SIZEOFECUMWAKEUPSTATEOFPCPARTITIONCONFIG                                               STD_ON
...
#define BSWM_NO_IMMEDIATEUSERENDIDXOFECUMWAKEUPMAPPING                                              255u
#define BSWM_NO_IMMEDIATEUSERSTARTIDXOFECUMWAKEUPMAPPING                                            255u
...
#define BSWM_ISDEF_EXTERNALIDOFECUMWAKEUPMAPPING                                                    STD_OFF
#define BSWM_ISDEF_IMMEDIATEUSERENDIDXOFECUMWAKEUPMAPPING                                           STD_OFF
#define BSWM_ISDEF_IMMEDIATEUSERSTARTIDXOFECUMWAKEUPMAPPING                                         STD_OFF
#define BSWM_ISDEF_IMMEDIATEUSERUSEDOFECUMWAKEUPMAPPING                                             STD_ON
#define BSWM_ISDEF_INITVALUEOFECUMWAKEUPMAPPING                                                     STD_ON
...
#define BSWM_ISDEF_ECUMWAKEUPMAPPINGOFPCPARTITIONCONFIG                                             STD_ON
#define BSWM_ISDEF_ECUMWAKEUPSTATEOFPCPARTITIONCONFIG                                               STD_ON
...
#define BSWM_EQ2_EXTERNALIDOFCANSMCHANNELMAPPING                                                    ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09
...
#define BSWM_EQ2_EXTERNALIDOFCOMMCHANNELMAPPING                                                     ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09
#define BSWM_EQ2_INITVALUEOFCOMMCHANNELMAPPING                                                      COMM_NO_COMMUNICATION
#define BSWM_EQ2_RULESIDXOFDEFERREDRULES                                                            
#define BSWM_EQ2_EXTERNALIDOFECUMWAKEUPMAPPING                                                      
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFECUMWAKEUPMAPPING                                             
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFECUMWAKEUPMAPPING                                           
#define BSWM_EQ2_IMMEDIATEUSERUSEDOFECUMWAKEUPMAPPING                                               TRUE
#define BSWM_EQ2_INITVALUEOFECUMWAKEUPMAPPING                                                       ECUM_WKSTATUS_NONE
...
#define BSWM_EQ2_ECUMWAKEUPMAPPINGOFPCPARTITIONCONFIG                                               BswM_EcuMWakeupMapping
#define BSWM_EQ2_ECUMWAKEUPSTATEOFPCPARTITIONCONFIG                                                 BswM_EcuMWakeupState
...
/**   \brief  type used to iterate BswM_EcuMWakeupMapping */
typedef uint8_least BswM_EcuMWakeupMappingIterType;

/**   \brief  type used to iterate BswM_EcuMWakeupState */
typedef uint8_least BswM_EcuMWakeupStateIterType;
...
/**   \brief  value based type definition for BswM_ExternalIdOfEcuMWakeupMapping */
typedef uint32 BswM_ExternalIdOfEcuMWakeupMappingType;

/**   \brief  value based type definition for BswM_ImmediateUserEndIdxOfEcuMWakeupMapping */
typedef uint8 BswM_ImmediateUserEndIdxOfEcuMWakeupMappingType;

/**   \brief  value based type definition for BswM_ImmediateUserStartIdxOfEcuMWakeupMapping */
typedef uint8 BswM_ImmediateUserStartIdxOfEcuMWakeupMappingType;

/**   \brief  value based type definition for BswM_ImmediateUserUsedOfEcuMWakeupMapping */
typedef boolean BswM_ImmediateUserUsedOfEcuMWakeupMappingType;
...
/**   \brief  value based type definition for BswM_SizeOfEcuMWakeupMapping */
typedef uint8 BswM_SizeOfEcuMWakeupMappingType;

/**   \brief  value based type definition for BswM_SizeOfEcuMWakeupState */
typedef uint8 BswM_SizeOfEcuMWakeupStateType;
...
/**   \brief  type used in BswM_EcuMWakeupMapping */
typedef struct sBswM_EcuMWakeupMappingType
{
  BswM_ExternalIdOfEcuMWakeupMappingType ExternalIdOfEcuMWakeupMapping;  /**< External id of BswMEcuMWakeupSource. */
  BswM_ImmediateUserEndIdxOfEcuMWakeupMappingType ImmediateUserEndIdxOfEcuMWakeupMapping;  /**< the end index of the 0:n relation pointing to BswM_ImmediateUser */
  BswM_ImmediateUserStartIdxOfEcuMWakeupMappingType ImmediateUserStartIdxOfEcuMWakeupMapping;  /**< the start index of the 0:n relation pointing to BswM_ImmediateUser */
} BswM_EcuMWakeupMappingType;
...
typedef struct BswM_ActionListQueueStructSTag
{
  ...
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_RX_Disable;
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_RX_EnableNoinit;
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_Disable_DM;
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_Enable_DM;
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_TX_Disable;
  BswM_ActionListQueueType AL_CC_AL_CN_DBCNetWork_9ed72b09_TX_EnableNoinit;
  BswM_ActionListQueueType AL_AL_Request_ComM_FULL_COM;
  BswM_ActionListQueueType AL_AL_Request_ComM_NO_COM;
...
typedef struct BswM_RuleStatesStructSTag
{
  ...
  BswM_RuleStatesType R_CC_CN_DBCNetWork_9ed72b09_RX;
  BswM_RuleStatesType R_CC_CN_DBCNetWork_9ed72b09_RX_DM;
  BswM_RuleStatesType R_CC_CN_DBCNetWork_9ed72b09_TX;
  BswM_RuleStatesType R_BswMRule_App_ComM_Request;
...
/**   \brief  type used to point to BswM_EcuMWakeupMapping */
typedef P2CONST(BswM_EcuMWakeupMappingType, TYPEDEF, BSWM_CONST) BswM_EcuMWakeupMappingPtrType;

/**   \brief  type used to point to BswM_EcuMWakeupState */
typedef P2VAR(EcuM_WakeupStateType, TYPEDEF, BSWM_VAR_NOINIT) BswM_EcuMWakeupStatePtrType;
...
extern VAR(ComM_ModeType, BSWM_VAR_NOINIT) Request_ModeReq_App_ComM_Mode_Request_Request_Mode;
