...
TASK(OsTask_App10ms_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_Unreachable */
{
  ...
  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Cyclic2_OsTask_App10ms_Core2_0_5ms | Rte_Ev_Run_AppCtrl2_AppCtrl2_MainFunction); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(OsTask_App10ms_Core2, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Cyclic2_OsTask_App10ms_Core2_0_5ms | Rte_Ev_Run_AppCtrl2_AppCtrl2_MainFunction)); /* PRQA S 3417 */ /* MD_Rte_Os */
    ...
    if ((ev & Rte_Ev_Run_AppCtrl2_AppCtrl2_MainFunction) != (EventMaskType)0)
    {
      /* call runnable */
      AppCtrl2_MainFunction(); /* PRQA S 2987 */ /* MD_Rte_2987 */
    }
  }
