...
#define BSWM_ID_RULE_CC_CN_DBCNetWork_9ed72b09_RX    11u 
#define BSWM_ID_RULE_CC_CN_DBCNetWork_9ed72b09_RX_DM 12u 
#define BSWM_ID_RULE_CC_CN_DBCNetWork_9ed72b09_TX    13u 
#define BSWM_ID_RULE_BswMRule_App_ComM_Request       14u 
...
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_RX_Disable      13u 
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_RX_EnableNoinit 14u 
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_Disable_DM      15u 
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_Enable_DM       16u 
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_TX_Disable      17u 
#define BSWM_ID_AL_CC_AL_CN_DBCNetWork_9ed72b09_TX_EnableNoinit 18u 
#define BSWM_ID_AL_AL_Request_ComM_FULL_COM                     19u 
#define BSWM_ID_AL_AL_Request_ComM_NO_COM                       20u 
...
#define BswM_GetEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)                                BswM_EcuMWakeupMapping  /**< the pointer to BswM_EcuMWakeupMapping */
#define BswM_GetEcuMWakeupStateOfPCPartitionConfig(partitionIndex)                                  BswM_EcuMWakeupState  /**< the pointer to BswM_EcuMWakeupState */
...
#define BswM_GetSizeOfActionListsOfPCPartitionConfig(partitionIndex)                                21u  /**< the number of accomplishable value elements in BswM_ActionLists */
...
#define BswM_GetSizeOfEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)                          2u  /**< the number of accomplishable value elements in BswM_EcuMWakeupMapping */
#define BswM_GetSizeOfEcuMWakeupStateOfPCPartitionConfig(partitionIndex)                            2u  /**< the number of accomplishable value elements in BswM_EcuMWakeupState */
...
#define BswM_GetSizeOfImmediateUserOfPCPartitionConfig(partitionIndex)                              4u  /**< the number of accomplishable value elements in BswM_ImmediateUser */
...
#define BswM_GetSizeOfRuleStatesOfPCPartitionConfig(partitionIndex)                                 15u  /**< the number of accomplishable value elements in BswM_RuleStates */
#define BswM_GetSizeOfRulesIndOfPCPartitionConfig(partitionIndex)                                   13u  /**< the number of accomplishable value elements in BswM_RulesInd */
...
#define BswM_GetExternalIdOfEcuMWakeupMapping(Index, partitionIndex)                                (BswM_GetEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)[(Index)].ExternalIdOfEcuMWakeupMapping)
#define BswM_GetImmediateUserEndIdxOfEcuMWakeupMapping(Index, partitionIndex)                       (BswM_GetEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)[(Index)].ImmediateUserEndIdxOfEcuMWakeupMapping)
#define BswM_GetImmediateUserStartIdxOfEcuMWakeupMapping(Index, partitionIndex)                     (BswM_GetEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)[(Index)].ImmediateUserStartIdxOfEcuMWakeupMapping)
#define BswM_GetEcuMWakeupState(Index, partitionIndex)                                              (BswM_GetEcuMWakeupStateOfPCPartitionConfig(partitionIndex)[(Index)])
...
/** 
  ...
  \{
*/ 
#define BswM_GetExternalIdOfCanSMChannelMapping(Index, partitionIndex)                              ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09  /**< External id of BswMCanSMIndication. */
...
#define BswM_GetExternalIdOfComMChannelMapping(Index, partitionIndex)                               ComMConf_ComMChannel_CN_DBCNetWork_9ed72b09  /**< External id of BswMComMIndication. */
#define BswM_GetInitValueOfComMChannelMapping(Index, partitionIndex)                                COMM_NO_COMMUNICATION  /**< Initialization value of port. */
#define BswM_IsImmediateUserUsedOfEcuMWakeupMapping(Index, partitionIndex)                          (((TRUE)) != FALSE)  /**< TRUE, if the 0:n relation has 1 relation pointing to BswM_ImmediateUser */
#define BswM_GetInitValueOfEcuMWakeupMapping(Index, partitionIndex)                                 ECUM_WKSTATUS_NONE  /**< Initialization value of port. */
...
#define BswM_GetSizeOfEcuMWakeupMapping(partitionIndex)                                             BswM_GetSizeOfEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)
#define BswM_GetSizeOfEcuMWakeupState(partitionIndex)                                               BswM_GetSizeOfEcuMWakeupStateOfPCPartitionConfig(partitionIndex)
...
#define BswM_SetEcuMWakeupState(Index, Value, partitionIndex)                                       BswM_GetEcuMWakeupStateOfPCPartitionConfig(partitionIndex)[(Index)] = (Value)
...
#define BswM_HasEcuMWakeupMapping(partitionIndex)                                                   (TRUE != FALSE)
#define BswM_HasExternalIdOfEcuMWakeupMapping(partitionIndex)                                       (TRUE != FALSE)
#define BswM_HasImmediateUserEndIdxOfEcuMWakeupMapping(partitionIndex)                              (TRUE != FALSE)
#define BswM_HasImmediateUserStartIdxOfEcuMWakeupMapping(partitionIndex)                            (TRUE != FALSE)
#define BswM_HasImmediateUserUsedOfEcuMWakeupMapping(partitionIndex)                                (TRUE != FALSE)
#define BswM_HasInitValueOfEcuMWakeupMapping(partitionIndex)                                        (TRUE != FALSE)
#define BswM_HasEcuMWakeupState(partitionIndex)                                                     (TRUE != FALSE)
...
#define BswM_HasSizeOfEcuMWakeupMapping(partitionIndex)                                             (TRUE != FALSE)
#define BswM_HasSizeOfEcuMWakeupState(partitionIndex)                                               (TRUE != FALSE)
...
#define BswM_HasEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)                                (TRUE != FALSE)
#define BswM_HasEcuMWakeupStateOfPCPartitionConfig(partitionIndex)                                  (TRUE != FALSE)
...
#define BswM_HasSizeOfEcuMWakeupMappingOfPCPartitionConfig(partitionIndex)                          (TRUE != FALSE)
#define BswM_HasSizeOfEcuMWakeupStateOfPCPartitionConfig(partitionIndex)                            (TRUE != FALSE)
...
#define BswM_IncEcuMWakeupState(Index, partitionIndex)                                              BswM_GetEcuMWakeupState(((Index)), (partitionIndex))++
...
#define BswM_DecEcuMWakeupState(Index, partitionIndex)                                              BswM_GetEcuMWakeupState(((Index)), (partitionIndex))--
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(BswM_EcuMWakeupMappingType, BSWM_CONST) BswM_EcuMWakeupMapping[2];
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[13];
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_WakeupStateType, BSWM_VAR_NOINIT) BswM_EcuMWakeupState[2];
#define BSWM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
